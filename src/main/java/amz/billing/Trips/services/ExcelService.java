...
public class ExcelService implements IExcelService {
    public static final List<Company> companyList = List.of(
            ...
            new Company(UUID.randomUUID().toString(), "Dorvaldary", List.of("SV23DDD"), "DORVALDARY SRL", 10, 10),
            new Company(UUID.randomUUID().toString(), "Ale & Dav", List.of("SV12JHH", "SV39JHH"), "Ale & Dav SRL", 5, 4.25),
            new Company(UUID.randomUUID().toString(), "Rup Transport", List.of("BT74DAN"), "RUP TRANSPORT SRL", 10, 10),
